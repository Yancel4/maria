...
//Inicializamos utter.
  ...
  annyang.addCommands({
    ...
    'google': function() {
		        ...
		        document.getElementById("google").value = "Redireccionando";
		        document.getElementById("google").className = "btn btn-lg btn-success btn-block";
		      }   
    });
    annyang.addCommands({
    'facebook': function() {
    ...
    'whatsapp': function() {
		        ...
		        document.getElementById("whatsapp").value = "Redireccionando";
		        document.getElementById("whatsapp").className = "btn btn-lg btn-success btn-block";
		      }   
    });
    annyang.addCommands({
    'instagram': function() {
		        window.location.href = "https://www.instagram.com/";
		        document.getElementById("instagram").value = "Redireccionando";
		        document.getElementById("instagram").className = "btn btn-lg btn-success btn-block";
		      }   
    });
     annyang.addCommands({
    'youtube': function() {
    ...
    'github': function() {
		        ...
		        document.getElementById("github").value = "Redireccionando";
		        document.getElementById("github").className = "btn btn-lg btn-success btn-block";
		      }   
    });
    annyang.addCommands({
    'gmail': function() {
		        window.location.href = "https://mail.google.com/";
		        document.getElementById("gmail").value = "Redireccionando";
		        document.getElementById("gmail").className = "btn btn-lg btn-success btn-block";
		      }   
    });
       annyang.addCommands({
